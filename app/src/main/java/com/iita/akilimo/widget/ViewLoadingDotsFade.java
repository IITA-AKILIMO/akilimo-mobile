package com.iita.akilimo.widget;
...
public class ViewLoadingDotsFade extends LinearLayout {
    ...
    public ViewLoadingDotsFade(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public ViewLoadingDotsFade(Context context, AttributeSet attrs, int defStyleAttr) {
