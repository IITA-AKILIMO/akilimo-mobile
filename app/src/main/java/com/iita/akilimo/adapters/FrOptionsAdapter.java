...
public class FrOptionsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private List<FrOptions> items;
    ...
    public interface OnItemClickListener {
        void onItemClick(View view, FrOptions obj, int position);
    }
    ...
    public FrOptionsAdapter(Context context, List<FrOptions> items, int animation_type) {
        this.items = items;
        ctx = context;
    ...
    public void onBindViewHolder(@NotNull RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof OriginalViewHolder) {
            ...
            FrOptions rec = items.get(position);
