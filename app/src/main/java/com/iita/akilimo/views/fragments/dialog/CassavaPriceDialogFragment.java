...
public class CassavaPriceDialogFragment extends DialogFragment {
    ...
    private ICassavaPriceDismissListener onDismissListener;
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        btnUpdate.setOnClickListener(v -> {
            ...
            if (isExactPriceRequired) {
                ...
                if (cassavaPrice <= 0) {
                    editExactFertilizerPrice.setError("Please provide a unit price");
                    isPriceValid = false;
                    return;
                }
                isPriceValid = true;
    ...
    public void setOnDismissListener(ICassavaPriceDismissListener dismissListener) {
