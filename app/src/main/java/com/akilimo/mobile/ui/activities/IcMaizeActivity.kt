...
class IcMaizeActivity : BaseActivity<ActivityRecommendationUseCaseBinding>() {
    ...
    override fun onBindingReady(savedInstanceState: Bundle?) {
        ...
        binding.fertilizerRecList.apply {
            layoutManager = LinearLayoutManager(this@IcMaizeActivity)
            adapter = recAdapter
        }

        binding.frButton.btnAction.setOnClickListener {
            val intent = Intent(this@IcMaizeActivity, GetRecommendationActivity::class.java)
