...
- *(inherit)* [**breaking**] Remove deprecated properties and update annotations
...
- *(deps)* Bump ejs from 3.1.9 to 3.1.10 (#322)
- Updated to JDK 21
...
- [**breaking**] Removed obsolete crashlytics logging
...
- [**breaking**] Refactore logic for investment preference
...
- [**breaking**] Updated to gradle 7.2
